...
class Evento extends ActiveRecord
{
    ...
    protected static $columnasDB = ['id', 'nombre', 'descripcion', 'disponibles', 'categoria_id', 'dia_id', 'hora_id', 'juego_id'];
    ...
    public function validar()
    {
        ...
        if (!$this->juego_id || !filter_var($this->juego_id, FILTER_VALIDATE_INT)) {
            self::$alertas['error'][] = 'Selecciona el juego encargada del evento';
        }
