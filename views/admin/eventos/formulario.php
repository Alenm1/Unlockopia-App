...
<fieldset class="formulario__fieldset">
    ...
    <div class="formulario__campo">
        <label for="juegos" class="formulario__label">Juego</label>
        <input type="text" class="formulario__input" id="juegos" placeholder="Buscar Juego">
        <ul id="listado-juegos" class="listado-juegos"></ul>

        <input type="hidden" name="juego_id" value="<?php echo $evento->juego_id; ?>">
    </div>

    <div class="formulario__campo">
        <label for="disponibles" class="formulario__label">Juegos Disponibles</label>
